...
class Contants {
  ...
  //   var last = Contants.lastDayOfMonth(month);
  //
 ...
 static getUserName() async {
  ...
  static getSelect(String names) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    // bool isCheckOut = prefs.getBool("checkSignout") ?? false;
    var name = prefs.getString(names);
    return name;
  }
  static setSelect(String names) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setString(names, "");
